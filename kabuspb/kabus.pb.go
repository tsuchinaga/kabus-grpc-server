...
var file_kabuspb_kabus_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x1d,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x38, 0x0a, 0x0e, 0x53, 0x79, 0x6d, 0x62,
	0x6f, 0x6c, 0x43, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f,
	0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x22, 0x46, 0x0a, 0x11, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64,
	...
	0x50, 0x55, 0x54, 0x5f, 0x50, 0x55, 0x54, 0x10, 0x02, 0x32, 0xa0, 0x04, 0x0a, 0x0c, 0x4b, 0x61,
	0x62, 0x75, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5b, 0x0a, 0x17, 0x47, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x58, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x52, 0x65, 0x67, 0x69, 0x73,
...
var file_kabuspb_kabus_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_kabuspb_kabus_proto_goTypes = []interface{}{
	...
	(*GetFutureSymbolCodeInfoRequest)(nil), // 3: kabuspb.GetFutureSymbolCodeInfoRequest
	(*GetOptionSymbolCodeInfoRequest)(nil), // 4: kabuspb.GetOptionSymbolCodeInfoRequest
	(*GetRegisteredSymbolsRequest)(nil),    // 5: kabuspb.GetRegisteredSymbolsRequest
	(*RegisterSymbolsRequest)(nil),         // 6: kabuspb.RegisterSymbolsRequest
	(*UnregisterSymbolsRequest)(nil),       // 7: kabuspb.UnregisterSymbolsRequest
	(*UnregisterAllSymbolsRequest)(nil),    // 8: kabuspb.UnregisterAllSymbolsRequest
	(*SymbolCodeInfo)(nil),                 // 9: kabuspb.SymbolCodeInfo
	(*RegisteredSymbols)(nil),              // 10: kabuspb.RegisteredSymbols
	(*RegisterSymbol)(nil),                 // 11: kabuspb.RegisterSymbol
...
var file_kabuspb_kabus_proto_depIdxs = []int32{
	...
	12, // 1: kabuspb.GetFutureSymbolCodeInfoRequest.derivative_month:type_name -> google.protobuf.Timestamp
	12, // 2: kabuspb.GetOptionSymbolCodeInfoRequest.derivative_month:type_name -> google.protobuf.Timestamp
	2,  // 3: kabuspb.GetOptionSymbolCodeInfoRequest.call_or_put:type_name -> kabuspb.CallPut
	11, // 4: kabuspb.RegisterSymbolsRequest.symbols:type_name -> kabuspb.RegisterSymbol
	11, // 5: kabuspb.UnregisterSymbolsRequest.symbols:type_name -> kabuspb.RegisterSymbol
	11, // 6: kabuspb.RegisteredSymbols.symbols:type_name -> kabuspb.RegisterSymbol
	0,  // 7: kabuspb.RegisterSymbol.exchange:type_name -> kabuspb.Exchange
	3,  // 8: kabuspb.KabusService.GetFutureSymbolCodeInfo:input_type -> kabuspb.GetFutureSymbolCodeInfoRequest
	4,  // 9: kabuspb.KabusService.GetOptionSymbolCodeInfo:input_type -> kabuspb.GetOptionSymbolCodeInfoRequest
	5,  // 10: kabuspb.KabusService.GetRegisteredSymbols:input_type -> kabuspb.GetRegisteredSymbolsRequest
	6,  // 11: kabuspb.KabusService.RegisterSymbols:input_type -> kabuspb.RegisterSymbolsRequest
	7,  // 12: kabuspb.KabusService.UnregisterSymbols:input_type -> kabuspb.UnregisterSymbolsRequest
	8,  // 13: kabuspb.KabusService.UnregisterAllSymbols:input_type -> kabuspb.UnregisterAllSymbolsRequest
	9,  // 14: kabuspb.KabusService.GetFutureSymbolCodeInfo:output_type -> kabuspb.SymbolCodeInfo
	9,  // 15: kabuspb.KabusService.GetOptionSymbolCodeInfo:output_type -> kabuspb.SymbolCodeInfo
	10, // 16: kabuspb.KabusService.GetRegisteredSymbols:output_type -> kabuspb.RegisteredSymbols
	10, // 17: kabuspb.KabusService.RegisterSymbols:output_type -> kabuspb.RegisteredSymbols
	10, // 18: kabuspb.KabusService.UnregisterSymbols:output_type -> kabuspb.RegisteredSymbols
	10, // 19: kabuspb.KabusService.UnregisterAllSymbols:output_type -> kabuspb.RegisteredSymbols
