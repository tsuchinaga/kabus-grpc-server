...
func Test_registerSymbol_GetAll(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "storeにデータがあればそれを返す",
			store: &registerSymbol{store: []*kabuspb.RegisterSymbol{{Symbol: "1234", Exchange: kabuspb.Exchange_TOUSHOU}, {Symbol: "2345", Exchange: kabuspb.Exchange_TOUSHOU}}},
			want:  []*kabuspb.RegisterSymbol{{Symbol: "1234", Exchange: kabuspb.Exchange_TOUSHOU}, {Symbol: "2345", Exchange: kabuspb.Exchange_TOUSHOU}}},
	}
...
func Test_registerSymbol_SetAll(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "データのある配列で上書き出る",
			store: &registerSymbol{store: []*kabuspb.RegisterSymbol{{Symbol: "1234", Exchange: kabuspb.Exchange_TOUSHOU}, {Symbol: "2345", Exchange: kabuspb.Exchange_TOUSHOU}}},
			arg:   []*kabuspb.RegisterSymbol{{Symbol: "3456", Exchange: kabuspb.Exchange_TOUSHOU}},
			want:  []*kabuspb.RegisterSymbol{{Symbol: "3456", Exchange: kabuspb.Exchange_TOUSHOU}}},
		{name: "空配列で上書きできる",
			store: &registerSymbol{store: []*kabuspb.RegisterSymbol{{Symbol: "1234", Exchange: kabuspb.Exchange_TOUSHOU}, {Symbol: "2345", Exchange: kabuspb.Exchange_TOUSHOU}}},
			arg:   []*kabuspb.RegisterSymbol{},
			want:  []*kabuspb.RegisterSymbol{}},
