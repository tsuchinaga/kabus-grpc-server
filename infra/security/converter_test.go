...
func Test_toExchangeDivision(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "東証プライム を変換できる", arg: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_PRIME, want: kabus.ExchangeDivisionToushouPrime},
		{name: "東証スタンダード を変換できる", arg: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_STANDARD, want: kabus.ExchangeDivisionToushouStandard},
		{name: "東証グロース を変換できる", arg: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_GROWTH, want: kabus.ExchangeDivisionToushouGrowth},
...
func Test_fromExchangeDivision(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "東証プライム を変換できる", arg: kabus.ExchangeDivisionToushouPrime, want: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_PRIME},
		{name: "東証スタンダード を変換できる", arg: kabus.ExchangeDivisionToushouStandard, want: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_STANDARD},
		{name: "東証グロース を変換できる", arg: kabus.ExchangeDivisionToushouGrowth, want: kabuspb.ExchangeDivision_EXCHANGE_DIVISION_TOUSHOU_GROWTH},
